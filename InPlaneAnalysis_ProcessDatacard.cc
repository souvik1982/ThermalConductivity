/*
==========================================
InPlaneAnalysis_ProcessDatacard
...
int main()
{
  ...
  {
    cout<<"ERROR: Datacard.html not found. Please run InPlaneAnalysis_ReadRaw on the CSV file from the experiment first."<<endl;
    return 0;
  }
  ...
  double apparatus_thermistorDistance,
         ...
         apparatus_fluxmeterWidth,
         apparatus_fluxmeterThickness,
    ...
    if (v_data.at(0) == "<pre>")
    {
      ...
      if (v_data.at(0) == "Apparatus Name" && v_data.at(1) == meta_apparatus)
      {
        while (v_data.at(0) != "</pre>")
        {
          ...
          if (v_data.at(0) == "Fluxmeter width (mm)")           apparatus_fluxmeterWidth = stod(v_data.at(1));
          if (v_data.at(0) == "Fluxmeter thickness (mm)")       apparatus_fluxmeterThickness = stod(v_data.at(1));
  ...
  cout<<"Analysis date: "<<meta_analysisDate<<endl;
  ...
  ofs_results<<"Apparatus fluxmeter width (mm), "<<apparatus_fluxmeterWidth<<endl;
  ofs_results<<"Apparatus fluxmeter thickness (mm), "<<apparatus_fluxmeterThickness<<endl;
